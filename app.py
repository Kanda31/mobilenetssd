...
lineaccesstoken = 'LgRxAmp2+Zj4V8Zwdqk5XVrSYhj6cL5ZZ8aI9YUcakvTbriAO9mz3WXNPAFQiO5+VX5ZnaPvj2BumfyZSxT0c9IEjUeH73szDUKkTVLq7VDCXUginCdrLH5FRleFsXGuZeTCat02dXvj1Lf/0XddXwdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "คุณทำอะไรอยู่" :
            replyObj = TextSendMessage(text="นอนเล่น")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "กินข้าวไหม" :
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/5139fb86-8920-43bf-b066-e8a2f160483f"
            equests.post(url,data=json_line, headers=json_headers)
    elif msgType == "image":
        try:
